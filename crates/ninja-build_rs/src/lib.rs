//! This crate has been renamed to [`build_safely`].
//!
//! You *can* still use `ninja-build_rs` which will remain a transparent shim, but I'd recommend
//! updating your dependency. All documentation examples use the new crate name.
//!
